    ...
    return function () {
        ...
        var e = {
                ...
                340: function (t, e, n) {
                    ...
                    e.default = function (t) {
                        t.API.autoTable = function () {
                            ...
                            var r = new i.DocHandler(this),
                                l = (0, o.parseHtml)(r, t, window, e, !1),
                                a = l.head,
                                s = l.body;
                            return {
                ...
                136: function (t, e) {
                    Object.defineProperty(e, "__esModule", {
                        ...
                        var i = r.internal.scaleFactor,
                            ...
                            a = l * (r.getLineHeightFactor ? r.getLineHeightFactor() : 1.15),
                            s = "",
                            u = 1;
                ...
                420: function (t, e) {
                    ...
                    Object.defineProperty(e, "__esModule", {
                        value: !0
                    }), e.getPageAvailableWidth = e.parseSpacing = e.getFillStyle = e.addTableBorder = e.getStringWidth = void 0, e.getStringWidth = function (t, e, n) {
                ...
                903: function (t, e, n) {
                    ...
                    e.parseCss = function (t, e, n, i, l) {
                        ...
                        var v = ["left", "right", "center", "justify"]; - 1 !== v.indexOf(i.textAlign) && (a.halign = i.textAlign), -1 !== (v = ["middle", "bottom", "top"]).indexOf(i.verticalAlign) && (a.valign = i.verticalAlign);
                ...
                776: function (t, e, n) {
                    ...
                    e.parseInput = function (t, e) {
                        ...
                        var c = function (t, e, n) {
                            ...
                            g = function (t, e) {
                                var n, o, r, l, a, s, u, d, h, c, f, g, p, y, v = (0, i.parseSpacing)(e.margin, 40 / t.scaleFactor()),
                                    m = null !== (n = function (t, e) {
                    ...
                    var a = function () {
                        ...
                        return t.prototype.getMaxCellHeight = function (t) {
                            ...
                            return t.reduce((function (t, o) {
                                ...
                                if (!r) return 0;
                                var i = e.getLineHeight(r.styles.fontSize),
                                    l = r.padding("vertical") + i;
                                return l > t ? l : t
                            }), 0)
                        }, t
                    }();
                ...
                664: function (t, e, n) {
                    ...
                    function d(t, e, n, o, r, i) {
                        ...
                        var l = Math.min(n + i, e.body.length),
                            a = -1;
                    ...
                    function f(t, e, n, o, i, a, s) {
                        var u = y(t, e, o, a);
                        if (n.canEntireRowFit(u, s)) g(t, e, n, a, s);
                    ...
                    function g(t, e, n, o, r) {
                        ...
                        for (var i = 0, l = r; i < l.length; i++) {
                            var s = l[i],
                                u = n.cells[s.index];
                            if (u)
                                if (t.applyStyles(u.styles), u.x = o.x, u.y = o.y, !1 !== e.callCellHooks(t, e.hooks.willDrawCell, u, n, s, o)) {
                                    p(t, u, o);
                                    var d = u.getTextPos();
                    ...
                    e.drawTable = function (t, e) {
                        ...
                        e.startPageNumber = b.pageNumber(), n.horizontalPageBreak ? function (t, e, n, o) {
                            var r = (0, s.calculateAllColumnsCanFitInPage)(t, e),
                                i = e.settings;
                            if ("afterAllRows" === i.horizontalPageBreakBehaviour) r.forEach((function (r, i) {
                                t.applyStyles(t.userStyles), i > 0 ? v(t, e, n, o, r.columns, !0) : u(t, e, o, r.columns),
                                    function (t, e, n, o, r) {
                ...
                224: function (t, e, n) {
                    ...
                    function r(t, e, n) {
                        var r;
                        void 0 === n && (n = {});
                        var i = (0, o.getPageAvailableWidth)(t, e),
                            l = new Map,
                            a = [],
                            s = [],
                            u = [];
                        ...
                        for (var d = !0, h = null !== (r = null == n ? void 0 : n.start) && void 0 !== r ? r : 0; h < e.columns.length;)
                            if (l.has(h)) h++;
                            else {
                ...
                324: function (t, e, n) {
                    ...
                    e.calculateWidths = function (t, e) {
                            ...
                            e.allRows().forEach((function (l) {
                                for (var a = 0, s = e.columns; a < s.length; a++) {
                                    ...
                                    if (d) {
                                        ...
                                        else if ("wrap" === d.styles.cellWidth || !0 === r) d.contentWidth > i ? (d.minWidth = i, d.wrappedWidth = i) : (d.minWidth = d.contentWidth, d.wrappedWidth = d.contentWidth);
                                        else {
                                            var g = 10 / n;
                        ...
                        a && (a = r(n, a, (function (t) {
                                ...
                                return t.minWidth
                            }))), a = Math.abs(a), !e.settings.horizontalPageBreak && a > .1 / t.scaleFactor() && (a = a < 1 ? a : Math.round(a), console.warn("Of the table content, ".concat(a, " units width could not fit page"))),
                            function (t) {
                                ...
                                for (var n = {
                                    ...
                                    for (var l = r[o], a = 0, s = t.columns; a < s.length; a++) {
                                        ...
                                        if (d) {
                                            ...
                                            else if ("ellipsize" === d.styles.overflow) d.text = i(d.text, h, d.styles, e, "...");
                                            else if ("hidden" === d.styles.overflow) d.text = i(d.text, h, d.styles, e, "");
